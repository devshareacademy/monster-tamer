...
import { InventoryScene } from './scenes/inventory/inventory-scene.js';
import { CutsceneScene } from './scenes/cutscene-scene.js';
import { DialogScene } from './scenes/dialog-scene.js';
import { ShopInventoryScene } from './scenes/inventory/shop-inventory-scene.js';
...
game.scene.add(SCENE_KEYS.SHOP_INVENTORY_SCENE, ShopInventoryScene);
